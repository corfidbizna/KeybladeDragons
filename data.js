...
var frGenesMap = {
    "Arapaima": {
        self: "Arapaima", 
        pair: "Arowana",
        species: ["Sandsurge", "Everlux"],
    },
    "Arc": {
        self: "Arc", 
        pair: "Loop",
        species: ["Veilspun", "Dusthide"],
    },
    "Bar": {
        self: "Bar", 
        pair: "Daub",
        species: ["Modern", "Gaoler", "Aberration", "Undertide", "Veilspun", "Aether", "Banescale", "Auraboa", "Dusthide", "Everlux", "Sandsurge"],
    },
    "Basic": {
        self: "Basic", 
        pair: "Basic",
    ...
    "Boulder": {
        self: "Boulder", 
        pair: "Myrid",
        species: ["Modern", "Undertide", "Aether", "Sandsurge", "Aberration", "Auraboa", "Banescale", "Gaoler", "Veilspun"],
    },
    "Candy": {
        self: "Candy", 
        pair: "Icing",
    ...
    "Checkers": {
        self: "Checkers", 
        pair: "Chess",
        species: ["Undertide", "Dusthide", "Aether", "Gaoler", "Modern", "Sandsurge"],
    },
    "Cherub": {
        self: "Cherub", 
        pair: "Seraph",
        species: ["Modern", "Banescale", "Undertide", "Sandsurge", "Aberration", "Dusthide", "Veilspun", "Everlux"],
    },
    "Chevron": {
        self: "Chevron", 
        pair: "Arrow",
    ...
    "Chorus": {
        self: "Chorus",
        pair: "Choir",
        species: ["Modern", "Veilspun"],
    },
    "Chrysocolla": {
        self: "Chrysocolla",
        pair: "Malachite",
        species: ["Modern", "Sandsurge", "Undertide", "Aether", "Everlux"],
    },
    "Cinder": {
        self: "Cinder", 
        pair: "Blaze",
        species: ["Aether", "Modern", "Aberration", "Banescale", "Gaoler", "Sandsurge", "Undertide", "Veilspun", "Dusthide"],
    },
    "Circulaworm": {
        self: "Circulaworm", 
        pair: "Silkspot",
    ...
    "Clown": {
        self: "Clown", 
        pair: "Eye Spot",
        species: ["Modern", "Banescale", "Veilspun", "Gaoler", "Aether", "Sandsurge", "Aberration", "Undertide"],
    },
    "Crystal": {
        self: "Crystal", 
        pair: "Facet",
        species: ["Modern", "Gaoler", "Aberration", "Undertide", "Veilspun", "Banescale", "Aether", "Everlux", "Sandsurge"],
    },
    "Diamond": {
        self: "Diamond", 
        pair: "Spade",
    ...
    "Fade": {
        self: "Fade", 
        pair: "Blend",
        species: ["Modern", "Veilspun", "Banescale", "Gaoler", "Aberration", "Undertide", "Aether", "Sandsurge", "Auraboa", "Dusthide", "Fade"],
    },
    "Falcon": {
        self: "Falcon", 
        pair: "Perigrine",
        species: ["Modern", "Gaoler", "Banescale", "Aberration", "Undertide", "Veilspun", "Auraboa", "Dusthide", "Aether", "Sandsurge"],
    },
    "Fern": {
        self: "Fern", 
        pair: "Paisley",
        species: ["Modern", "Banescale", "Veilspun", "Aberration", "Auraboa", "Undertide", "Aether", "Sandsurge"],
    },
    "Flaunt": {
        self: "Flaunt", 
        pair: "Flare",
        species: ["Modern", "Aberration", "Gaoler", "Aether", "Sandsurge", "Auraboa", "Undertide", "Everlux"],
    },
    "Giraffe": {
        self: "Giraffe", 
        pair: "Hex",
        species: ["Modern", "Gaoler", "Banescale", "Veilspun", "Aberration", "Undertide", "Auraboa", "Undertide", "Dusthide", "Aether"],
    },
    "Ground": {
        self: "Ground", 
        pair: "Fissure",
        species: ["Modern", "Aberration", "Sandsurge", "Undertide", "Dusthide", "Aether"],
    },
    "Harlequin": {
        self: "Harlequin", 
        pair: "Jester",
        species: ["Modern", "Sandsurge", "Aberration", "Auraboa", "Undertide", "Dusthide", "Aether", "Gaoler"],
    },
    "Iridescent": {
        self: "Iridescent", 
        pair: "Shimmer",
    ...
    "Jupiter": {
        self: "Jupiter", 
        pair: "Saturn",
        species: ["Modern", "Veilspun", "Aether", "Sandsurge", "Undertide", "Dusthide", "Everlux"],
    },
    "Laced": {
        self: "Laced", 
        pair: "Edged",
        species: ["Modern", "Banescale", "Veilspun", "Gaoler", "Aether", "Auraboa", "Dusthide", "Everlux"],
    },
    "Leopard": {
        self: "Leopard", 
        pair: "Clouded",
    ...
    "Lionfish": {
        self: "Lionfish", 
        pair: "Noxtide",
        species: ["Modern", "Aberration", "Undertide", "Aether", "Sandsurge", "Everlux", "Gaoler"],
    },
    "Love": {
        self: "Love",
        pair: "Affection",
    ...
    "Marble": {
        self: "Marble", 
        pair: "Mottle",
        species: ["Banescale", "Everlux"],
    },
    "Metallic": {
        self: "Metallic", 
        pair: "Alloy",
        species: ["Modern", "Banescale", "Aether", "Auraboa", "Undertide"],
    },
    "Mochlus": {
        self: "Mochlus",
        pair: "Riopa",
    ...
    "Mosaic": {
        self: "Mosaic", 
        pair: "Breakup",
        species: ["Modern", "Gaoler", "Aether", "Sandsurge", "Auraboa", "Aberration", "Banescale", "Dusthide", "Veilspun"],
    },
    "Octopus": {
        self: "Octopus", 
        pair: "Rings",
    ...
    "Orb": {
        self: "Orb", 
        pair: "Weaver",
        species: ["Aberration", "Auraboa", "Undertide", "Aether", "Bansecale", "Gaoler", "Sandsurge", "Veilspun", "Modern", "Dusthide"],
    },
    "Papillon": {
        self: "Papillon", 
        pair: "Swallowtail",
    ...
    "Petals": {
        self: "Petals", 
        pair: "Butterfly",
        species: ["Modern", "Banescale", "Veilspun", "Aether", "Undertide", "Dusthide", "Everlux", "Sandsurge"],
    },
    "Petrified": {
        self: "Petrified",
        pair: "Lode",
        species: ["Dusthide", "Modern", "Everlux", "Sandsurge"],
    },
    "Phantom": {
        self: "Phantom", 
        pair: "Spirit",
    ...
    "Pharaoh": {
        self: "Pharaoh", 
        pair: "Sarcophagus",
        species: ["Modern", "Aberration", "Undertide", "Banescale", "Everlux"],
    },
    "Piebald": {
        self: "Piebald", 
        pair: "Paint",
        species: ["Modern", "Gaoler", "Aether", "Sandsurge", "Auraboa", "Undertide", "Dusthide", "Everlux"],
    },
    "Pinstripe": {
        self: "Pinstripe", 
        pair: "Trail",
        species: ["Modern", "Gaoler", "Banescale", "Undertide", "Sandsurge", "Aberration", "Dusthide", "Everlux"],
    },
    "Poison": {
        self: "Poison", 
        pair: "Toxin",
        species: ["Modern", "Banescale", "Undertide", "Veilspun", "Gaoler", "Aberration", "Everlux"],
    },
    "Python": {
        self: "Python", 
        pair: "Morph",
        species: ["Modern", "Aether", "Sandsurge", "Auraboa", "Everlux"],
    },
    "Ragged": {
        self: "Ragged", 
        pair: "Tear",
        species: ["Banescale", "Sandsurge"],
    },
    "Rattlesnake": {
        self: "Rattlesnake", 
        pair: "Diamondback",
    ...
    "Ribbon": {
        self: "Ribbon", 
        pair: "Eel",
        species: ["Modern", "Aberration", "Undertide", "Gaoler", "Banescale", "Dusthide", "Aether", "Sandsurge"],
    },
    "Ripple": {
        self: "Ripple", 
        pair: "Current",
        species: ["Modern", "Gaoler", "Banescale", "Undertide", "Aberration", "Auraboa", "Dusthide", "Aether", "Everlux"],
    },
    "Sailfish": {
        self: "Sailfish",
        pair: "Marlin",
        species: ["Sandsurge", "Dusthide"],
    },
    "Savanna": {
        self: "Savanna", 
        pair: "Safari",
        species: ["Modern", "Banescale", "Aberration", "Undertide", "Sandsurge", "Dusthide", "Aether"],
    },
    "Shaggy": {
        self: "Shaggy", 
        pair: "Streak",
    ...
    "Skink": {
        self: "Skink", 
        pair: "Spinner",
        species: ["Modern", "Banescale", "Veilspun", "Aether", "Gaoler", "Aberration", "Dusthide", "Everlux", "Sandsurge"],
    },
    "Slime": {
        self: "Slime", 
        pair: "Sludge",
        species: ["Modern", "Aberration", "Veilspun", "Gaoler", "Sandsurge", "Aether", "Everlux"],
    },
    "Soil": {
        self: "Soil",
        pair: "Loam",
        species: ["Modern", "Aberration", "Aether", "Auraboa", "Banescale", "Dusthide", "Gaoler", "Sandsurge", "Undertide", "Veilspun", "Everlux"],
    },
    "Speckle": {
        self: "Speckle", 
        pair: "Freckle",
        species: ["Modern", "Aberration", "Undertide", "Veilspun", "Banescale", "Dusthide"],
    },
    "Sphinxmoth": {
        self: "Sphinxmoth", 
        pair: "Hawkmoth",
        species: ["Veilspun", "Everlux", "Sandsurge"],
    },
    "Spool": {
        self: "Spool", 
        pair: "Thread",
    ...
    "Starmap": {
        self: "Starmap", 
        pair: "Constelation",
        species: ["Modern", "Veilspun", "Aether", "Aberration", "Auraboa", "Undertide", "Everlux"],
    },
    "Stitched": {
        self: "Stitched", 
        pair: "Patched",
        species: ["Modern", "Veilspun", "Aberration", "Aether", "Gaoler", "Undertide"],
    },
    "Strike": {
        self: "Strike",
        pair: "Coil",
        species: ["Dusthide", "Everlux"],
    },
    "Swirl": {
        self: "Swirl", 
        pair: "Marbled",
        species: ["Modern", "Aberration", "Undertide", "Gaoler", "Sandsurge"],
    },
    "Tapir": {
        self: "Tapir", 
        pair: "Striation",
        species: ["Modern", "Gaoler", "Veilspun", "Banescale", "Aberration", "Sandsurge", "Auraboa", "Undertide", "Aether"],
    },
    "Throne": {
        self: "Throne", 
        pair: "Crown",
    ...
    "Tide": {
        self: "Tide", 
        pair: "Foam",
        species: ["Modern", "Undertide", "Aether", "Gaoler", "Banescale", "Aberration", "Everlux"],
    },
    "Tiger": {
        self: "Tiger", 
        pair: "Stripes",
        species: ["Modern", "Gaoler", "Banescale", "Sandsurge", "Auraboa", "Undertide", "Aether", "Everlux"],
    },
    "Twinkle": {
        self: "Twinkle", 
        pair: "Flicker",
    ...
    "Wasp": {
        self: "Wasp", 
        pair: "Bee",
        species: ["Modern", "Gaoler", "Veilspun", "Aberration", "Undertide", "Sandsurge", "Dusthide", "Aether"],
    },
    "Wicker": {
        self: "Wicker",
        pair: "Woven",
    ...
    "Wrought": {
        self: "Wrought", 
        pair: "Spire",
        species: ["Sandsurge", "Undertide", "Dusthide", "Aether"],
    },
};
var frGenesTertMap = {
    "Angler": ["Veilspun", "Gaoler", "Undertide", "Dusthide", "Aether"],
    "Antlers": ["Dusthide"],
    "Augment": ["Sandsurge", "Aberration", "Dusthide", "Everlux"],
    "Basic": [],
    "Batty": ["Auraboa", "Dusthide", "Everlux", "Sandsurge"],
    "Beard": ["Sandsurge"],
    "Beetle": ["Veilspun"],
    "Blossom": ["Gaoler", "Undertide", "Dusthide", "Aether", "Veilspun"],
    "Braids": ["Gaoler", "Aberration", "Aether"],
    "Branches": ["Veilspun", "Sandsurge", "Auraboa", "Undertide", "Aether", "Gaoler"],
    "Brightshine": ["Veilspun", "Undertide"],
    "Capsule": ["Modern", "Veilspun", "Banescale", "Gaoler", "Aberration", "Undertide", "Auraboa", "Aether", "Sandsurge"],
    "Carnivore": ["Aberration", "Aether", "Banescale", "Gaoler", "Undertide", "Veilspun", "Dusthide", "Sandsurge"],
    "Chitin": ["Sandsurge", "Everlux"],
    "Circuit": ["Modern", "Undertide", "Aether", "Gaoler"],
    "Contour": ["Modern", "Banescale", "Aether", "Gaoler", "Aberration", "Auraboa", "Undertide"],
    "Crackle": ["Modern", "Banescale", "Veilspun", "Undertide", "Auraboa", "Aether"],
    "Crest": ["Sandsurge", "Auraboa", "Undertide"],
    "Crystalline": ["Auraboa", "Gaoler"],
    "Darts": ["Sandsurge"],
    "Dewlap": ["Dusthide"],
    "Diaphanous": ["Veilspun", "Aether"],
    "Eclipse": ["Everlux", "Modern", "Undertide", "Veilspun", "Sandsurge"],
    "Eclosion": ["Everlux"],
    "Fangs": ["Aberration"],
    "Fans": ["Banescale", "Gaoler", "Aberration", "Undertide", "Aether"],
    "Featherbeard": ["Undertide"],
    "Filigree": ["Modern", "Banescale", "Undertide", "Veilspun"],
    "Firebreather": ["Modern", "Aberration", "Auraboa", "Undertide", "Aether", "Banescale", "Gaoler", "Sandsurge", "Veilspun"],
    "Firefly": ["Modern", "Veilspun", "Aberration", "Auraboa", "Undertide", "Aether", "Sandsurge"],
    "Fishbone": ["Sandsurge", "Auraboa", "Dusthide", "Aether", "Everlux"],
    "Flameforger": ["Aberration", "Banescale", "Aether", "Sandsurge"],
    "Flecks": ["Veilspun", "Modern", "Aberration", "Undertide", "Aether", "Sandsurge"],
    "Flutter": ["Aether", "Everlux"],
    "Frills": ["Aberration"],
    "Gecko": ["Everlux", "Modern", "Aberration", "Aether", "Auraboa", "Banescale", "Dusthide", "Gaoler", "Sandsurge", "Undertide", "Veilspun"],
    "Gembond": ["Modern", "Undertide", "Aether", "Sandsurge", "Dusthide", "Everlux"],
    "Ghost": ["Modern", "Gaoler", "Banescale", "Aberration", "Undertide", "Veilspun", "Dusthide", "Aether"],
    "Gliders": ["Banescale", "Everlux"],
    "Glimmer": ["Modern", "Aberration", "Banescale", "Gaoler", "Veilspun"],
    "Glitch": ["Everlux"],
    "Glowtail": ["Modern", "Aberration", "Aether", "Dusthide"],
    "Gnarlhorns": ["Gaoler", "Sandsurge"],
    "Harp": ["Everlux"],
    "Jellyfish": ["Undertide", "Everlux"],
    "Jewels": ["Aberration"],
    "Keel": ["Modern", "Aether", "Sandsurge", "Auraboa", "Undertide"],
    "Koi": ["Modern", "Veilspun", "Aberration", "Auraboa", "Undertide", "Aether"],
    "Kumo": ["Aberration", "Sandsurge", "Everlux"],
    "Lace": ["Modern", "Banescale", "Aether", "Sandsurge"],
    "Mandibles": ["Aether", "Dusthide", "Everlux", "Sandsurge"],
    "Marlin": ["Sandsurge"],
    "Medusa": ["Auraboa", "Undertide", "Aether"],
    "Mistral": ["Banescale", "Undertide"],
    "Monarch": ["Aether", "Banescale"],
    "Mop": ["Veilspun"],
    "Mucous": ["Aberration"],
    "Nudibranch": ["Undertide", "Aether", "Everlux"],
    "Okapi": ["Modern", "Gaoler", "Veilspun", "Undertide", "Sandsurge", "Dusthide"],
    "Opal": ["Modern", "Veilspun", "Auraboa", "Undertide", "Dusthide"],
    "Ornaments": ["Aether"],
    "Pachy": ["Dusthide"],
    "Paradise": ["Auraboa", "Everlux"],
    "Peacock": ["Modern", "Veilspun", "Aberration", "Banescale", "Sandsurge", "Auraboa", "Everlux"],
    "Pinions": ["Gaoler"],
    "Plating": ["Undertide"],
    "Plumage": ["Banescale", "Auraboa"],
    "Points": ["Modern", "Aether", "Everlux"],
    "Polkadot": ["Aberration", "Modern", "Auraboa", "Dusthide", "Everlux", "Sandsurge"],
    "Polypore": ["Aberration"],
    "Porcupine": ["Banescale", "Auraboa", "Undertide", "Aether"],
    "Pufferfish": ["Undertide"],
    "Remora": ["Undertide"],
    "Rift": ["Everlux"],
    "Ringlets": ["Modern", "Gaoler", "Banescale", "Undertide", "Dusthide"],
    "Riot": ["Aberration", "Gaoler", "Veilspun", "Dusthide"],
    "Rockbreaker": ["Auraboa", "Sandsurge"],
    "Runes": ["Modern", "Gaoler", "Veilspun", "Undertide", "Sandsurge", "Everlux"],
    "Sailfin": ["Undertide", "Auraboa", "Aether"],
    "Scales": ["Modern", "Aberration", "Aether", "Auraboa", "Undertide", "Everlux"],
    "Scorpion": ["Gaoler"],
    "Scuttle": ["Auraboa", "Everlux"],
    "Shardflank": ["Gaoler"],
    "Shark": ["Sandsurge", "Undertide"],
    "Skeletal": ["Banescale", "Aberration"],
    "Smirch": ["Modern", "Aether", "Sandsurge", "Aberration", "Undertide"],
    "Smoke": ["Modern", "Gaoler", "Aether", "Auraboa", "Undertide", "Dusthide", "Everlux", "Sandsurge"],
    "Soap": ["Modern", "Undertide", "Banescale", "Sandsurge", "Aether", "Gaoler"],
    "Space": ["Aether", "Everlux"],
    "Sparkle": ["Modern", "Aberration", "Banescale", "Gaoler", "Veilspun", "Undertide", "Aether", "Sandsurge", "Dusthide", "Everlux"],
    "Spectre": ["Sandsurge"],
    "Spines": ["Modern", "Aether", "Banescale", "Sandsurge", "Aberration", "Auraboa", "Undertide", "Dusthide", "Everlux"],
    "Spores": ["Dusthide", "Aether", "Everlux", "Sandsurge"],
    "Squiggle": ["Banescale"],
    "Stained": ["Modern", "Banescale", "Gaoler", "Veilspun", "Undertide", "Aether", "Sandsurge", "Aberration", "Auraboa", "Dusthide", "Everlux"],
    "Starfall": ["Aether", "Sandsurge", "Auraboa", "Gaoler"],
    "Stinger": ["Aether", "Auraboa", "Undertide"],
    "Sunsail": ["Everlux"],
    "Tentacles": ["Undertide", "Aether"],
    "Terracotta": ["Auraboa"], 
    "Thorns": ["Veilspun", "Aberration", "Auraboa", "Undertide", "Aether", "Banescale", "Dusthide", "Gaoler", "Sandsurge", "Everlux"],
    "Thundercrack": ["Sandsurge", "Gaoler"],
    "Thylacine": ["Modern", "Gaoler", "Aberration", "Sandsurge", "Aether"],
    "Topcoat": ["Auraboa", "Undertide", "Dusthide"],
    "Trickmurk": ["Aether", "Veilspun"],
    "Trimmings": ["Banescale"],
    "Underbelly": ["Modern", "Gaoler", "Banescale", "Veilspun", "Undertide", "Aberration", "Aether", "Sandsurge", "Auraboa", "Dusthide", "Everlux"],
    "Veil": ["Dusthide"],
    "Veined": ["Modern", "Banescale", "Aberration", "Undertide", "Veilspun", "Aether"],
    "Warrior": ["Banescale", "Sandsurge", "Veilspun"],
    "Wavecrest": ["Dusthide", "Undertide"],
    "Weathered": ["Gaoler"],
    "Whiskers": ["Aether", "Dusthide", "Everlux", "Gaoler", "Sandsurge"],
    "Willow": ["Auraboa"],
    "Wintercoat": ["Gaoler"],
    "Wish": ["Aether", "Modern", "Everlux"],
    "Wool": ["Everlux"],
}
var fRGenesPrimary = [
    "Basic",
...
var fRGenePairs = [
    ...
    ["Lionfish", "Noxtide"],
    ["Laced", "Edged"],
    ["Giraffe (Gaoler)", "Hex (Gaoler)"],
    ["Wasp (Gaoler)", "Bee (Gaoler)"],
    ["Shaggy (Gaoler)", "Streak (Gaoler)"],
    ["Falcon (Gaoler)", "Perigrine (Gaoler)"],
    ["Piebald (Gaoler)", "Paint (Gaoler)"],
    ["Pinstripe (Gaoler)", "Trail (Gaoler)"],
    ["Jaguar (Gaoler)", "Rosette (Gaoler)"],
    ["Bar (Gaoler)", "Daub (Gaoler)"],
    ["Tapir (Gaoler)", "Striation (Gaoler)"],
    ["Tiger (Gaoler)", "Stripes (Gaoler)"],
    ["Crystal (Gaoler)", "Facet (Gaoler)"],
    ["Mosaic (Gaoler)", "Breakup (Gaoler)"],
    ["Phantom (Gaoler)", "Spirit (Gaoler)"],
    ["Leopard", "Clouded"],
    ["Slime", "Sludge"],
    ["Fade", "Blend"],
    ["Cherub (Banescale)", "Seraph (Banescale)"],
    ["Jaguar (Banescale)", "Rosette (Banescale)"],
    ["Pinstripe (Banescale)", "Trail (Banescale)"],
    ["Tiger (Banescale)", "Stripes (Banescale)"],
    ["Marble (Banescale)", "Mottle (Banescale)"],
    ["Laced (Banescale)", "Edged (Banescale)"],
    ["Metallic (Banescale)", "Alloy (Banescale)"],
    ["Savanna (Banescale)", "Safari (Banescale)"],
    ["Petals (Banescale)", "Butterfly (Banescale)"],
    ["Skink (Banescale)", "Spinner (Banescale)"],
    ["Poison (Banescale)", "Toxin (Banescale)"],
    ["Chevron (Banescale)", "Arrow (Banescale)"],
    ["Candycane (Banescale)", "Sugarplum (Banescale)"],
    ["Ragged (Banescale)", "Tear (Banescale)"],
    ["Swirl", "Marbled"],
    ["Mosaic", "Breakup"],
    ["Stitched", "Patched"],
    ["Fade (Veilspun)", "Blend (Veilspun)"],
    ["Laced (Veilspun)", "Edged (Veilspun)"],
    ["Tapir (Veilspun)", "Striation (Veilspun)"],
    ["Vipera (Veilspun)", "Hypnotic (Veilspun)"],
    ["Jupiter (Veilspun)", "Saturn (Veilspun)"],
    ["Starmap (Veilspun)", "Constellation (Veilspun)"],
    ["Stitched (Veilspun)", "Patched (Veilspun)"],
    ["Skink (Veilspun)", "Spinner (Veilspun)"],
    ["Wasp (Veilspun)", "Bee (Veilspun)"],
    ["Bright (Veilspun)", "Vivid (Veilspun)"],
    ["Arc (Veilspun)", "Loop (Veilspun)"],
    ["Shell (Veilspun)", "Web (Veilspun)"],
    ["Sphinxmoth (Veilspun)", "Hawkmoth (Veilspun)"],
    ["Laced (Gaoler)", "Edged (Gaoler)"],
    ["Tapir (Banescale)", "Striation (Banescale)"],
    ["Clown (Banescale)", "Eye Spots (Banescale)"],
    ["Clown (Veilspun)", "Eye Spots (Veilspun)"],
    ["Clown (Gaoler)", "Eye Spots (Gaoler)"],
    ["Ripple (Gaoler)", "Current (Gaoler)"],
    ["Ripple (Banescale)", "Current (Banescale)"],
    ["Falcon (Banescale)", "Perigrine (Banescale)"],
    ["Giraffe (Banescale)", "Hex (Banescale)"],
    ["Flaunt", "Flare"],
    ["Giraffe (Veilspun)", "Hex (Veilspun)"],
    ["Ribbon", "Eel"],
    ["Fade (Banescale)", "Blend (Banescale)"],
    ["Fade (Gaoler)", "Blend (Gaoler)"],
    ["Pharaoh", "Sarcophagus"],
    ["Ground", "Fissure"],
    ["Orb (Aberration)", "Weaver (Aberration)"],
    ["Diamond (Aberration)", "Spade (Aberration)"],
    ["Fade (Aberration)", "Blend (Aberration)"],
    ["Bar (Aberration)", "Daub (Aberration)"],
    ["Crystal (Aberration)", "Facet (Aberration)"],
    ["Falcon (Aberration)", "Perigrine (Aberration)"],
    ["Giraffe (Aberration)", "Hex (Aberration)"],
    ["Tapir (Aberration)", "Striation (Aberration)"],
    ["Vipera (Aberration)", "Hypnotic (Aberration)"],
    ["Ground (Aberration)", "Fissure (Aberration)"],
    ["Jaguar (Aberration)", "Rosette (Aberration)"],
    ["Lionfish (Aberration)", "Noxtide (Aberration)"],
    ["Speckle (Aberration)", "Freckle (Aberration)"],
    ["Pharaoh (Aberration)", "Sarciphagus (Aberration)"],
    ["Savanna (Aberration)", "Safari (Aberration)"],
    ["Swirl (Aberration)", "Marbled (Aberration)"],
    ["Slime (Aberration)", "Sludge (Aberration)"],
    ["Ribbon (Aberration)", "Eel (Aberration)"],
    ["Stitched (Aberration)", "Patched (Aberration)"],
    ["Wasp (Aberration)", "Bee (Aberration)"],
    ["Clouded (Banescale)", "Leopard (Aberration)"],
    ["Boulder", "Myrid"],
    ["Flaunt (Aberration)", "Flare (Aberration)"],
    ["Flaunt (Gaoler)", "Flare (Gaoler)"],
    ["Tide", "Foam"],
    ["Wolf (Undertide)", "Pack (Undertide)"],
    ["Checkers (Undertide)", "Chess (Undertide)"],
    ["Boa (Undertide)", "Saddle (Undertide)"],
    ["Octopus (Undertide)", "Rings (Undertide)"],
    ["Fade (Undertide)", "Blend (Undertide)"],
    ["Bar (Undertide)", "Daub (Undertide)"],
    ["Crystal (Undertide)", "Facet (Undertide)"],
    ["Falcon (Undertide)", "Peregrine (Undertide)"],
    ["Giraffe (Undertide)", "Hex (Undertide)"],
    ["Lionfish (Undertide)", "Noxtide (Undertide)"],
    ["Speckle (Undertide)", "Freckle (Undertide)"],
    ["Pharaoh (Undertide)", "Sarcophagus (Undertide)"],
    ["Savanna (Undertide)", "Safari (Undertide)"],
    ["Swirl (Undertide)", "Marbled (Undertide)"],
    ["Ribbon (Undertide)", "Eel (Undertide)"],
    ["Tide (Undertide)", "Foam (Undertide)"],
    ["Wasp (Undertide)", "Bee (Undertide)"],
    ["Cherub (Undertide)", "Seraph (Undertide)"],
    ["Pinstripe (Undertide)", "Trail (Undertide)"],
    ...
    ["Bar (Aether)", "Daub (Aether)"],
    ["Boulder (Aether)", "Myrid (Aether)"],
    ["Clown (Aether)", "Eye Spots (Aether)"],
    ["Fade (Aether)", "Blend (Aether)"],
    ["Flaunt (Aether)", "Flare (Aether)"],
    ["Jaguar (Aether)", "Rosette (Aether)",],
    ["Jupiter (Aether)", "Saturn (Aether)"],
    ["Laced (Aether)", "Edged (Aether)"],
    ["Lionfish (Aether)", "Noxtide (Aether)"],
    ["Metalic (Aether)", "Alloy (Aether)"],
    ["Mosaic (Aether)", "Breakup (Aether)"],
    ["Petals (Aether)", "Butterfly (Aether)"],
    ["Piebald (Aether)", "Paint (Aether)"],
    ["Python (Aether)", "Morph (Aether)"],
    ["Slink (Aether)", "Spinner (Aether)"],
    ...
    ["Arapaima (Sandsurge)", "Arowana (Sandsurge)"],
    ["Wrought (Sandsurge)", "Spire (Sandsurge)"],
    ["Rattlesnake (Sandsurge)", "Diamondback (Sandsurge)"],
    ["Boa (Sandsurge)", "Saddle (Sandsurge)"],
    ["Boulder (Sandsurge)", "Myrid (Sandsurge)"],
    ["Cherub (Sandsurge)", "Seraph (Sandsurge)"],
    ["Flaunt (Sandsurge)", "Flare (Sandsurge)"],
    ["Fade (Sandsurge)", "Blend (Sandsurge)"],
    ["Jupiter (Sandsurge)", "Saturn (Sandsurge)"],
    ["Jaguar (Sandsurge)", "Rosette (Sandsurge)"],
    ["Lionfish (Sandsurge)", "Noxtide (Sandsurge)"],
    ["Clown (Sandsurge)", "Eye Spots (Sandsurge)"],
    ["Ground (Sandsurge)", "Fissure (Sandsurge)"],
    ["Harlequin (Sandsurge)", "Jester (Sandsurge)"],
    ["Python (Sandsurge)", "Morph (Sandsurge)"],
    ["Slime (Sandsurge)", "Sludge (Sandsurge)"],
    ["Wasp (Sandsurge)", "Bee (Sandsurge)"],
    ["Piebald (Sandsurge)", "Paint (Sandsurge)"],
    ["Swirl (Sandsurge)", "Marbled (Sandsurge)"],
    ["Tiger (Sandsurge)", "Stripes (Sandsurge)"],
    ["Mosaic (Sandsurge)", "Breakup (Sandsurge)"],
    ["Tapir (Sandsurge)", "Striation (Sandsurge)"],
    ["Savanna (Sandsurge)", "Safari (Sandsurge)"],
    ["Cinder", "Blaze"],
    ["Cinder (Aberration)", "Blaze (Aberration)"],
    ["Cinder (Banescale)", "Blaze (Banescale)"],
    ["Cinder (Gaoler)", "Blaze (Gaoler)"],
    ["Cinder (Sandsurge)", "Blaze (Sandsurge)"],
    ["Cinder (Undertide)", "Blaze (Undertide)"],
    ["Cinder (Veilspun)", "Blaze (Veilspin)"],
];
var fRGenesTertiary = [
    "Basic",
    "Circuit",
    ...
    "Carnivore (Veilspun)",
    "Polkadot",
    "Brightshine (Veilspun)",
    "Brightshine (Undertide)",
    "Chitin (Sandsurge)",
    "Crest (Sandsurge)",
    "Beard (Sandsurge)",
    "Fishbone (Sandsurge)",
